    ...
    <div className="w-full mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between p-8">
        ...
        <div className="md:w-1/2 md:pl-8 justify-center">
          <h2 className="text-6xl font-light">Free up resources, <br/> accelerate growth,<br/> and solve for scale.</h2>
          ...
          <br/>
          <p className="mt-4 text-xl text-gray-600">Now that’s outsourcing worth talking about.</p>
        </div>
      </div>
